        ...
        2: [function(require, module, exports) {
            ...
            class h {
                ...
                filter(t, e, s, a) {
                    ...
                    i.data = h, i.data.length ? (this.rebuild(), i.update()) : (i.clear(), i.setMessage(i.options.labels.noRows)), s || i.emit("datatable.sort", t, e)
                }
                sort(t, e, s) {
                    const a = this.dt;
                    ...
                    if ("date" === c.getAttribute("data-type")) {
                        ...
                        c.hasAttribute("data-format") && (t = c.getAttribute("data-format")), p.push(Promise.resolve().then((function() {
                            return require("./date-ee454f51.js")
                        })).then((({
                            parseDate: e
                        }) => s => e(s, t))))
                    }
                    Promise.all(p).then((n => {
                        ...
                        })), e || (e = c.classList.contains("asc") ? "desc" : "asc"), "desc" == e ? (g = i(r, -1), u = i(l, -1), c.classList.remove("asc"), c.classList.add("desc")) : (g = i(l, 1), u = i(r, 1), c.classList.remove("desc"), c.classList.add("asc")), a.lastTh && c != a.lastTh && (a.lastTh.classList.remove("desc"), a.lastTh.classList.remove("asc")), a.lastTh = c, h = g.concat(u), a.data = [];
                        const f = [];
                        h.forEach(((t, e) => {
                        ...
                        if ("txt" !== o.type && "csv" !== o.type || (a[0] = this.header), o.selection)
                            if (isNaN(o.selection)) {
                                if (Array.isArray(o.selection))
                                    for (n = 0; n < o.selection.length; n++) a = a.concat(this.pages[o.selection[n] - 1])
                            } else a = a.concat(this.pages[o.selection - 1]);
                        ...
                        if (a.length) {
                            if ("txt" === o.type || "csv" === o.type) {
                                ...
                                for (h = 0; h < a.length; h++)
                                    for (i[h] = i[h] || {}, n = 0; n < s.length; n++) !o.skipColumn.includes(s[n].originalCellIndex) && this.columns(s[n].originalCellIndex).visible() && (i[h][s[n].textContent] = a[h].cells[n].textContent);
